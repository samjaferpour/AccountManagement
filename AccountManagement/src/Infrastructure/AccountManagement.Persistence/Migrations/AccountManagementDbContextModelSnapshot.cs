...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AccountManagement.Domain.Entities.Account", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        ...
                        .HasDefaultValue(new DateTime(2023, 1, 27, 20, 39, 0, 341, DateTimeKind.Local).AddTicks(6902));
                    ...
                    b.Property<DateTime>("ModifiedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 1, 27, 20, 39, 0, 341, DateTimeKind.Local).AddTicks(6961));
            ...
            modelBuilder.Entity("AccountManagement.Domain.Entities.BlockAccountTransaction", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 1, 27, 20, 39, 0, 342, DateTimeKind.Local).AddTicks(599));
                    ...
                    b.Property<DateTime>("ModifiedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 1, 27, 20, 39, 0, 342, DateTimeKind.Local).AddTicks(657));
            ...
            modelBuilder.Entity("AccountManagement.Domain.Entities.Customer", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 1, 27, 20, 39, 0, 341, DateTimeKind.Local).AddTicks(7600));
                    ...
                    b.Property<DateTime>("ModifiedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 1, 27, 20, 39, 0, 341, DateTimeKind.Local).AddTicks(7679));
            ...
            modelBuilder.Entity("AccountManagement.Domain.Entities.DemandPacket", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 1, 27, 20, 39, 0, 341, DateTimeKind.Local).AddTicks(7999));
                    ...
                    b.Property<DateTime>("ModifiedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 1, 27, 20, 39, 0, 341, DateTimeKind.Local).AddTicks(8063));
            ...
            modelBuilder.Entity("AccountManagement.Domain.Entities.Letter", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 1, 27, 20, 39, 0, 341, DateTimeKind.Local).AddTicks(5856));
                    ...
                    b.Property<DateTime>("ModifiedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 1, 27, 20, 39, 0, 341, DateTimeKind.Local).AddTicks(6030));
            ...
            modelBuilder.Entity("AccountManagement.Domain.Entities.Transaction", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 1, 27, 20, 39, 0, 341, DateTimeKind.Local).AddTicks(9557));
                    ...
                    b.Property<DateTime>("ModifiedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 1, 27, 20, 39, 0, 341, DateTimeKind.Local).AddTicks(9703));
            ...
            modelBuilder.Entity("AccountManagement.Domain.Entities.WithdrawAccountTransaction", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 1, 27, 20, 39, 0, 342, DateTimeKind.Local).AddTicks(1040));
                    ...
                    b.Property<DateTime>("ModifiedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 1, 27, 20, 39, 0, 342, DateTimeKind.Local).AddTicks(1092));
            ...
            modelBuilder.Entity("AccountManagement.Domain.Entities.BlockAccountTransaction", b =>
                {
                    b.HasOne("AccountManagement.Domain.Entities.Account", "Account")
                        .WithOne("BlockAccountTransaction")
                        .HasForeignKey("AccountManagement.Domain.Entities.BlockAccountTransaction", "AccountId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("AccountManagement.Domain.Entities.WithdrawAccountTransaction", b =>
                {
                    b.HasOne("AccountManagement.Domain.Entities.Account", "Account")
                        .WithOne("WithdrawAccountTransaction")
                        .HasForeignKey("AccountManagement.Domain.Entities.WithdrawAccountTransaction", "AccountId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("AccountManagement.Domain.Entities.Account", b =>
                {
                    b.Navigation("BlockAccountTransaction")
                        .IsRequired();

                    b.Navigation("Customers");

                    b.Navigation("WithdrawAccountTransaction")
                        .IsRequired();
                });
